...
let rec insert x = function
  ...
  | Node(lt, a, rt) -> if x < a then Node(insert x lt, a, rt) else Node(lt, a, insert x rt)

let rec member x = function
  | Empty -> false
  | Node(lt, a, rt) when x = a -> true
  | Node(lt, a, rt) when x < a -> member x lt
  | Node(lt, a, rt) -> member x rt
(*----------------------------------------------------------------------------*]
...
let rec member2 x = function
  |Empty -> false
  |Node(lt, a, rt) -> x = a || member x lt || member x rt
(*----------------------------------------------------------------------------*]
